...
"""
    ...
    >> Reecriture de l'interpolation des sections efficaces. Correction du BigBug
...
def Ssearcher(T_array,P_array,compo_array,sigma_array,P_sample,T_sample,rank,rank_ref,Kcorr,oneD=False,Optimal=False) :
    ...
    for i in xrange( i_Tu_arr.size ):
        ...
        if Optimal == False :
            ...
            if rank == rank_ref :
                print k_pd_Td[300],k_pu_Td[300],k_pd_Tu[300],k_pu_Tu[300],k_rmd[i,300]
    ...
    for i in range(size) :
        ...
        if rank == rank_ref :
            if i%100 == 0. or i == size - 1 :
                bar.animate(i + 1)
            print T, P, i_Tu, i_Td, T_sample[i_Tu], T_sample[i_Td], i_pu, i_pd, P_sample[i_pu], P_sample[i_pd], coeff_1, coeff_2, coeff_3, coeff_4
